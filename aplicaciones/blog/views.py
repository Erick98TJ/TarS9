...
def generales(request):
    ...
    if queryset:
        posts = Post.objects.filter(
            ...
            estado= True,
            categoria= Categoria.objects.get(nombre__iexact= "General"),).distinct()
...
def programacion(request):
    ...
    if queryset:
        posts = Post.objects.filter(
            ...
            Q(descripcion__icontains=queryset),
            estado= True,
            categoria= Categoria.objects.get(nombre__iexact= "Programación'"),).distinct()
...
def tutoriales(request):
    ...
    if queryset:
        posts = Post.objects.filter(
            ...
            Q(descripcion__icontains=queryset),
            estado= True,
            categoria= Categoria.objects.get(nombre__iexact= "Tutoriales'"),).distinct()
...
def tecnologia(request):
    ...
    if queryset:
        posts = Post.objects.filter(
            ...
            Q(descripcion__icontains=queryset),
            estado= True,
            categoria= Categoria.objects.get(nombre__iexact= "Tecnología'"),).distinct()
...
def videojuegos(request):
    ...
    if queryset:
        posts = Post.objects.filter(
            ...
            Q(descripcion__icontains=queryset),
            estado= True,
            categoria= Categoria.objects.get(nombre__iexact= "Video Juegos'"),).distinct()
